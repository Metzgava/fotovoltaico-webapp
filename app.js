...
function renderIstruzioni() {
  ...
  const card = h("div", { class: "section-card instr", html: `
    ...
    <p><b>Costo virtuale (senza impianto)</b> = (kWh autoconsumati + kWh prelevati dalla rete) × costo medio €/kWh dell'anno — cioè quanto avresti pagato per TUTTO il tuo consumo se non avessi il fotovoltaico. Per gli anni “Stima”: consumo annuo ipotizzato × prezzo €/kWh di mercato × (1 + % IVA).</p>
